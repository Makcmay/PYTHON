...
for item in capitals.items():  # вывод пары ('Россия', 'Москва') ключ и позиция
    print(item)

capitals = {'Россия': 'Москва', 'Франция': 'Париж', 'Чехия': 'Прага'}

for key, value in capitals.items():  # вывод пары ('Россия', 'Москва') ключ и позиция аналог items но можно работать с элементами
    print(key, '-', value)
...
capitals = {'Россия': 'Москва', 'Франция': 'Париж', 'Чехия': 'Прага'} # ключ : значение
...
# result = {}
# for num in numbers:
#     result[num] += 1 # так работать не будет, см ниже
...
new_info = info # копирование, изменит значение в новом словаре и в старом
new_info['name'] = 'Tim'
...
new_info = info.copy() # глубокое копирование, изменит значение в новом словаре и сохранит в старом
new_info['name'] = 'Tim'
...
info = dict(zip(keys, values)) # склеит по индексам словари в новый, обрезается по самому короткому если длинна разная
print(info)